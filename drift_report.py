# Importing the os module for interacting with the operating system such as working with file paths and directories
import os
...
# Changing the current working directory to the directory where this script file is located
# __file__ gives the path of the script, abspath converts it to absolute path and dirname extracts the folder
os.chdir(os.path.dirname(os.path.abspath(__file__)))


# Creating the path to the SQLite database file by joining the script directory with the database name
